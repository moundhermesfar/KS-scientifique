  ...
  return (
    <nav id="nav" className="z-50 shadow-md w-full fixed top-0 left-0">
      <div className="h-[70px] md:flex items-center justify-between bg-white py-4 md:px-10 px-7">
        ...
        <ul
          className={`mr-[7%] md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-top duration-500 ease-in ${
